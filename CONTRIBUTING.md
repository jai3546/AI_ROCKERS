...
_Note: Always base your work on a new branch created from the latest version of the `main` branch. Avoid making commits directly on the `main` branch._

### Frontend Development

If you are working on frontend features or components, download the latest Next.js agents documentation:

```bash
npm run install-nextjs-docs
```

This ensures you have the most recent documentation and references for Next.js features that may be used throughout the codebase.
