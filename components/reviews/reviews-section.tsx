...
const localizedReviews: Record<"en" | "hi" | "te", ReviewData[]> = {
  ...
  te: [
    ...
    },
    {
      ...
      avatar: "/avatars/priya.jpg",
      rating: 5,
      comment: "డౌట్ సాల్వింగ్ మరియు నోట్స్ జనరేషన్ ఫీచర్లు అద్భుతం. 24/7 వ్యక్తిగత ట్యూటర్ ఉన్నట్టుగా అనిపిస్తుంది!",
      date: "",
    },
    {
      id: "3",
      name: "Rohan Verma",
      role: "బి.ఎస్‌సి విద్యార్థి",
      avatar: "/avatars/rohan.jpg",
      rating: 5,
    ...
    },
    {
      id: "4",
      name: "Ananya Gupta",
      role: "బి.కామ్ విద్యార్థిని",
      avatar: "/avatars/ananya.jpg",
      rating: 5,
      comment: "జవాబులు ఎంత ఖచ్చితంగా, తక్షణంగా వస్తాయో నాకు చాలా ఇష్టం. VidyaAI నిజంగా గేమ్-చేంజర్!",
      date: "",
    },
  ],
}
